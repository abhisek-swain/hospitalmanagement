...
<head>
    ...
    <title> Arogyam Hospital</title>
    <link rel="icon" type="image/x-icon" href="Arogyam.png">
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">Arogyam
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown"> Arogyam Hospital</h5>
                        <p>Arogyam Hospital is one of the oldest and largest  in the country. Established in the pre-independence era, it still continues it’s saga of serving the people of the State and outside by providing free medical services to one and all. The College has been the Alma Mater of many stalwarts of the medical fraternity across the world and continues to produce more than 2000 trained medical and paramedical professionals every year.</p>
